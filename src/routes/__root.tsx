...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Registro, GPS, reportes y comunicación PTT para la movilización de vehículos de alquiler entre terminales y base." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@moviliza_pro" },
    ],
    links: [
      {
        rel: "stylesheet",
